...
// Add these components before your FormField component:

export const EyeIcon: FC<{ color?: string; size?: number }> = ({ 
  color = '#B1B1B1', 
  size = 20 
}) => (
...
export const EyeOffIcon: FC<{ color?: string; size?: number }> = ({ 
  color = '#B1B1B1', 
  size = 20 
}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
