...
const styles = StyleSheet.create({
  ...
  clearText: { color: C.accent, fontSize: 12, fontFamily: 'Satoshi-Medium' },
  ...
  emptySub: { marginTop: 8, color: C.sub, fontSize: 14, textAlign: 'center', fontFamily: 'Satoshi-Regular', lineHeight: 20, marginBottom: 28 },
  ...
  listContent: { padding: 16, paddingBottom: 240, gap: 10 },
  ...
  itemImageWrap: { width: 82, height: 82, borderRadius: 14, overflow: 'hidden', backgroundColor: '#F5F1EE', flexShrink: 0 },
  itemImage: { width: '100%', height: '100%' },
  itemBody: { flex: 1 },
  itemTopRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 },
  itemName: { flex: 1, color: C.text, fontSize: 14, fontFamily: 'Satoshi-Bold', lineHeight: 19, letterSpacing: -0.1 },
  deleteBtn: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  itemUnitPrice: { marginTop: 3, color: C.muted, fontSize: 12, fontFamily: 'Satoshi-Regular' },
  ...
  qtyBtn: { width: 30, height: 30, alignItems: 'center', justifyContent: 'center', backgroundColor: C.bg },
  qtyBtnDisabled: { opacity: 0.4 },
  qtyText: { minWidth: 30, textAlign: 'center', color: C.text, fontSize: 13, fontFamily: 'Satoshi-Bold' },
  itemTotal: { color: C.accent, fontSize: 16, fontFamily: 'Satoshi-Bold', letterSpacing: -0.2 },
  ...
  summaryLabel: { color: C.sub, fontSize: 14, fontFamily: 'Satoshi-Regular' },
  summaryValue: { color: C.text, fontSize: 14, fontFamily: 'Satoshi-Medium' },
  summaryFree: { color: C.success, fontSize: 14, fontFamily: 'Satoshi-Medium' },
